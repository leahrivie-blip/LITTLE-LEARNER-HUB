...
- **Enrichment Editor Slice 1** ready for owner review — see [ENRICHMENT_EDITOR_SLICE1.md](./ENRICHMENT_EDITOR_SLICE1.md)
...
| Tests | `npm run test:teaching-kit-slice-1a` … `1f` + `test:teaching-kit-phase1-qa` + `test:teaching-kit-enrichment-slice-1` |
