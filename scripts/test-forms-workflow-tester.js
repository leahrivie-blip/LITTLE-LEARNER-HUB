...
async function runBrowser() {
  ...
  try {
    ...
    await page.addInitScript(({ email, childId: id, oldMealId: mealId }) => {
    ...
    // Archive does not delete; restore works
    await page.evaluate((id) => {
    ...
    // Owner vs teacher: archive controls
    ...
    console.log("PASS  playwright forms workflow (mobile viewport, archive, injury, meals, roles)");
  } finally {
