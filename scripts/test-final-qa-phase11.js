...
const EXPECTED_LOCAL_SHELL = "20260809-phase11-admin-tester-session-go17";
...
function inspectLocalShellMarkers() {
  ...
  const checks = {
    ...
    indexCacheBust: /app\.js\?v=20260809-phase11-admin-tester-session-go17/.test(indexHtml),
  };
