...
test("cache bust versions stay aligned for admin stay-logged-in", () => {
  ...
  assert.equal(indexCss, "20260717-admin-notif-pwa");
  assert.equal(indexJs, "20260717-admin-notif-pwa");
  assert.match(sw, /styles\.css\?v=20260717-admin-notif-pwa/);
  assert.match(sw, /app\.js\?v=20260717-admin-notif-pwa/);
  assert.match(sw, /llh-shell-v64-admin-notif-pwa/);
});
