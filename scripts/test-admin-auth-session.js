...
test("cache bust versions stay aligned for admin stay-logged-in", () => {
  ...
  assert.equal(indexCss, "20260715-admin-stay");
  assert.equal(indexJs, "20260715-admin-stay");
  assert.match(sw, /styles\.css\?v=20260715-admin-stay/);
  assert.match(sw, /app\.js\?v=20260715-admin-stay/);
