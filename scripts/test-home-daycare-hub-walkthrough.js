...
const SHELL = "20260803-family-hub-polish2";
...
async function main() {
  ...
  assert.match(sw, /llh-shell-v164-family-hub-polish2/);
  assert.equal(manifest.version, SHELL);
  assert.equal(manifest.cacheName, "llh-shell-v164-family-hub-polish2");
