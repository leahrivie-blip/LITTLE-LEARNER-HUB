...
const SHELL = "20260803-p1-security-correctness";
...
async function main() {
  ...
  assert.match(sw, /llh-shell-v168-p1-security-correctness/);
  assert.equal(manifest.version, SHELL);
  assert.equal(manifest.cacheName, "llh-shell-v168-p1-security-correctness");
