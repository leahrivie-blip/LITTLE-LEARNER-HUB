...
const SHELL = "20260803-family-hub-polish4";
...
async function main() {
  ...
  assert.match(sw, /llh-shell-v166-family-hub-polish4/);
  assert.equal(manifest.version, SHELL);
  assert.equal(manifest.cacheName, "llh-shell-v166-family-hub-polish4");
