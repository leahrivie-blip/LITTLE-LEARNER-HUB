...
const SHELL = "20260803-family-hub-polish";
...
async function main() {
  ...
  assert.match(sw, /llh-shell-v163-family-hub-polish/);
  assert.equal(manifest.version, SHELL);
  assert.equal(manifest.cacheName, "llh-shell-v163-family-hub-polish");
