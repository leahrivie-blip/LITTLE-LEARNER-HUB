...
const SHELL = "20260803-family-hub-beta-final";
...
async function main() {
  ...
  assert.match(sw, /llh-shell-v167-family-hub-beta-final/);
  assert.equal(manifest.version, SHELL);
  assert.equal(manifest.cacheName, "llh-shell-v167-family-hub-beta-final");
