...
function main() {
  ...
  ok(sw.includes("20260804-final-provider-polish-r2"), "shell cache bumped for perf pass");
  ok(indexHtml.includes("20260804-final-provider-polish-r2"), "index cache bumped for perf pass");
