...
function main() {
  ...
  ok(sw.includes("20260804-pass3-cookie-mobile-r1"), "shell cache bumped for perf pass");
  ok(indexHtml.includes("20260804-pass3-cookie-mobile-r1"), "index cache bumped for perf pass");
