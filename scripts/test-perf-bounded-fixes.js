...
function main() {
  ...
  ok(sw.includes("20260805-tk-owner-preview-r1"), "shell cache bumped for perf pass");
  ok(indexHtml.includes("20260805-tk-owner-preview-r1"), "index cache bumped for perf pass");
