...
function main() {
  ...
  ok(sw.includes("20260804-remaining-polish-r1"), "shell cache bumped for perf pass");
  ok(indexHtml.includes("20260804-remaining-polish-r1"), "index cache bumped for perf pass");
