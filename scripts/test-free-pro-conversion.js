...
test("cache bust versions aligned", () => {
  ...
  assert.match(sw, /free-curriculum-sample\.js\?v=20260718-messages-admin-mobile/);
  assert.match(sw, /free-plan-grandfathering\.js\?v=20260718-messages-admin-mobile/);
});
