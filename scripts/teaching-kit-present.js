...
(function (root, factory) {
  ...
  const LABEL_MAP = Object.freeze({
    ...
    week_binder: "Entire Binder Kit",
    entire_binder: "Entire Binder Kit",
    full_weekly_plan: "Full Weekly Lesson Plan",
    full_weekly: "Full Weekly Lesson Plan",
    weekly_overview: "Weekly Overview",
    today_pack: "One Day",
    activities_only: "Activities Only",
    one_activity: "One Activity",
    songs_pack: "Songs",
    one_song: "One Song",
    song_lyrics: "Song Lyrics / Song Guide",
    book_guide: "Book Guide",
    materials_list: "Materials List",
    teacher_toolkit: "Teacher Toolkit",
    all_printables: "All Printables",
    one_printable: "One Printable",
