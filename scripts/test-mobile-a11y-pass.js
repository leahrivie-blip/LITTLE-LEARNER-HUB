...
function main() {
  ...
  ok(sw.includes("20260804-final-provider-polish-r1"), "shell cache bumped for a11y pass");
  ok(indexHtml.includes("20260804-final-provider-polish-r1"), "index cache bumped for a11y pass");
