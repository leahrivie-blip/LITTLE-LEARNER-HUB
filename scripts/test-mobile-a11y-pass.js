...
function main() {
  ...
  ok(sw.includes("20260804-trial-length-audit-r1"), "shell cache bumped for a11y pass");
  ok(indexHtml.includes("20260804-trial-length-audit-r1"), "index cache bumped for a11y pass");
