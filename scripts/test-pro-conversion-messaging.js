...
async function main() {
  ...
  assertIncludes(appJs, "Unlock unlimited lesson plans, the full Activity Center, new lesson plans added every week", "value prop");
  assertIncludes(appJs, "Ready for more?", "free library headline");
  assertIncludes(appJs, "Love what you’ve seen so far?", "dashboard headline");
