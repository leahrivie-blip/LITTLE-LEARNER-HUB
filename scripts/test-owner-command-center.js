...
test("cache bust versions stay aligned", () => {
  ...
  assert.equal(indexCss, "20260719-system-health-monitor");
  assert.equal(indexJs, "20260719-system-health-monitor");
  assert.match(sw, /llh-shell-v103-system-health-monitor/);
});
