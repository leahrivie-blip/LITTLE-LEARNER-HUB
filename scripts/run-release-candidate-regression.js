...
const SUITES = [
  ...
  { name: "SEO curriculum hub", cmd: "npm", args: ["run", "test:seo-curriculum-hub"] },
  ...
  { name: "Staff beta access", cmd: "npm", args: ["run", "test:staff-beta-access"] },
  ...
  { name: "Staff Plan billing", cmd: "npm", args: ["run", "test:staff-plan"] },
