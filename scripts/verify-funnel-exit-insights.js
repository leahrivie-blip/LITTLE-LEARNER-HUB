...
function scopeGuard() {
  ...
  const disallowed = files.filter((f) =>
    !/admin-insights|verify-marketing-funnel|verify-funnel-exit|test-admin-insights|test-admin-metric-accuracy|admin-metrics-accuracy-audit|llh-admin-workspace|service-worker|index\.html|package\.json|server\/index\.js/.test(f));
