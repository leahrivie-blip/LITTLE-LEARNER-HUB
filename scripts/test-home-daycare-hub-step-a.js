...
test("shell markers: hub nav, view, client-config, shell version", () => {
  ...
  assert.match(indexHtml, /SHELL_VERSION = "20260730-(hdh-(step-[a-d]|finish|guide)|ai-guide-p1)"/);
  assert.match(indexHtml, /app\.js\?v=20260730-(hdh-(step-[a-d]|finish|guide)|ai-guide-p1)/);
});
