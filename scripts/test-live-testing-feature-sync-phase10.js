...
function unitDocs() {
  ...
  assert.match(tracker, /91%|10 of 11|10\/11/);
  assert.match(tracker, /do not start until Phase 10 confirmed|Phase 11/i);
  assert.match(tracker, /Do not deploy after Phase 10|written deploy approval/i);
