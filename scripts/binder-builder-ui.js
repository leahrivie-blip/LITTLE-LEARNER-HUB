...
(function initBinderBuilderUi(global) {
  ...
  function renderPrintStep() {
    return [
      ...
      `<p class="bb-lesson-meta">Tip: Use your browser’s Print dialog and enable background graphics only if you want soft washes; text remains readable without them.</p>`,
