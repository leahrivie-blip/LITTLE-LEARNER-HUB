...
(function initBinderBuilderUi(global) {
  ...
  function renderPrintStep() {
    return [
      ...
      `<ul>`,
      `<li><strong>Paper:</strong> US Letter (8.5 × 11). The Weekly Grid Calendar is landscape — choose landscape for that sheet if your browser asks, or print with “background graphics” on and prefer the Save as PDF path below.</li>`,
      `<li><strong>Layout:</strong> Portrait for most pages</li>`,
