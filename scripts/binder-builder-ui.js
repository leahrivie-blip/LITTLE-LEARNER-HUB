...
(function initBinderBuilderUi(global) {
  ...
  function renderPrintStep() {
    return [
      ...
      `<li><strong>Margins:</strong> Default (Binder Builder already includes page margins)</li>`,
      `<li><strong>Background graphics:</strong> ON (keeps soft washes and planner styling)</li>`,
      `<li><strong>Headers and footers:</strong> OFF — turn these off in your browser print dialog. Binder Builder cannot remove browser-added date/URL/Page X chrome.</li>`,
      `</ul>`,
      `</aside>`,
      `<div class="bb-toolbar">`,
      `<button type="button" class="primary-button" data-bb-action="print">Print Binder</button>`,
      `</div>`,
      `</div>`,
    ].join("");
  }
