...
/** @typedef {"account_created"|"session_started"|"lesson_viewed"|"activity_viewed"|"lesson_saved"|"printable_viewed"|"printable_downloaded"|"pro_content_encountered"|"pricing_viewed"|"upgrade_cta_clicked"|"checkout_started"|"checkout_completed"|"paid_subscription_active"} ConversionEventName */

/** @typedef {{ featureType?: string, lessonId?: string, lessonTitle?: string, ageGroup?: string, location?: string, ctaLocation?: string, resourceId?: string, title?: string, category?: string, access?: string, plan?: string, source?: string, utm_source?: string, utm_medium?: string, utm_campaign?: string, utm_content?: string, utm_term?: string, [key: string]: string|number|boolean|undefined }} ConversionEventDetail */
...
const LEGACY_EVENT_MAP = Object.freeze({
  ...
  upgrade_prompt_shown: "pro_content_encountered",
