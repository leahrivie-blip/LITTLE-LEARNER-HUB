...
const EMAIL_TEXT = [
  ...
  "",
  "👀 You're seeing the same free lesson plans.",
  "",
  "That's because the Free Library is designed to give you a sample of what's available, while Pro Members unlock the full library with new lesson plans, activities, and resources being added regularly.",
  "",
  "With Pro Membership You Get:",
  "",
  "⭐ Full Lesson Plan Library",
  "⭐ New Lesson Plans Added Weekly",
  "⭐ Full Activity Center Access",
  "⭐ Premium Planning Tools",
  "⭐ Documentation Helpers",
  "⭐ Exclusive Resources & Future Features",
  "",
  "Special Reminder",
  "",
