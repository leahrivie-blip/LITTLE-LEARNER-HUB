...
function summarizeForm(store, form) {
  ...
  return {
    ...
    sourceTemplateVersionId: form.sourceTemplateVersionId || "",
    sourceTemplateVersionNumber: form.sourceTemplateVersionNumber || 0,
    builtInSource: form.builtInSource === true,
