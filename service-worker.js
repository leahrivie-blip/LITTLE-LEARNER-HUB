const CACHE_NAME = "llh-shell-v104-owner-command-health";
const OFFLINE_URL = "/offline.html";
const APP_SHELL = [
  "/",
  "/index.html",
  "/offline.html",
  "/styles.css?v=20260719-owner-command-health",
  ...
  "/styles/llh-messaging.css?v=20260719-owner-command-health",
  ...
  "/scripts/free-curriculum-sample.js?v=20260719-owner-command-health",
  "/scripts/free-plan-grandfathering.js?v=20260719-owner-command-health",
  "/app.js?v=20260719-owner-command-health",
  "/comms-center.js?v=20260719-owner-command-health",
  "/site.webmanifest",
