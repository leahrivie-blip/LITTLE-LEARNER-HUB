const CACHE_NAME = "llh-shell-v137-hdh-role-switcher";
const SHELL_VERSION = "20260730-hdh-role-switcher";
...
const APP_SHELL = [
  ...
  "/index.html",
  "/offline.html",
  "/styles.css?v=20260730-hdh-role-switcher",
  "/styles/llh-admin-workspace.css?v=20260730-hdh-role-switcher",
  "/styles/llh-design-tokens.css?v=20260713-ds",
  "/styles/llh-homepage.css?v=20260730-hdh-role-switcher",
  "/styles/llh-library-browse.css?v=20260717-netflix-cover-cards",
  "/styles/llh-messaging.css?v=20260730-hdh-role-switcher",
  "/styles/llh-comms.css?v=20260730-hdh-role-switcher",
  "/scripts/curriculum-safe-values.js?v=20260712-v3-render-fix",
  "/scripts/lesson-plan-cover-catalog.js?v=20260730-hdh-role-switcher",
  "/scripts/lesson-plan-covers.js?v=20260730-hdh-role-switcher",
  ...
  "/scripts/curriculum-lesson-viewer-render.js?v=20260730-hdh-role-switcher",
  ...
  "/scripts/free-curriculum-sample.js?v=20260730-hdh-role-switcher",
  "/scripts/trial-curriculum-exports.js?v=20260730-hdh-role-switcher",
  "/scripts/free-plan-grandfathering.js?v=20260730-hdh-role-switcher",
  "/app.js?v=20260730-hdh-role-switcher",
  "/admin-workspace.js?v=20260730-hdh-role-switcher",
  "/comms-center.js?v=20260730-hdh-role-switcher",
  "/site.webmanifest",
