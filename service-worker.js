const CACHE_NAME = "llh-shell-v198-tk-binder-pdf-fix-r2";
const SHELL_VERSION = "20260809-tk-binder-pdf-fix-r2";
...
const APP_SHELL = [
  ...
  "/scripts/llh-lesson-docx.js?v=20260808-tk-selective-print",
  "/scripts/lesson-plan-weekly-export.js?v=20260717-more-menu",
  "/scripts/llh-teacher-weekly-planner.js?v=20260808-tk-selective-print",
  ...
  "/scripts/teaching-kit-mapper.js?v=20260809-tk-binder-pdf-fix-r2",
  "/scripts/teaching-kit-printable-model.js?v=20260809-tk-binder-pdf-fix-r2",
  "/scripts/vendor/pdf-lib.min.js?v=20260808-tk-pdf-merge",
  "/scripts/vendor/html2canvas.min.js?v=20260808-tk-pdf-merge",
  "/scripts/teaching-kit-printable-pdf-merge.js?v=20260808-tk-pdf-merge",
  "/scripts/teaching-kit-binder-pdf.js?v=20260809-tk-binder-pdf-fix-r2",
  "/scripts/teaching-kit.js?v=20260803-tk-quality-review",
  "/scripts/teaching-kit-present.js?v=20260808-tk-pdf-merge",
  "/scripts/teaching-kit-print.js?v=20260809-tk-binder-pdf-fix-r2",
  "/scripts/teaching-kit-viewer.js?v=20260809-tk-binder-pdf-fix-r2",
  "/scripts/curriculum-day-field-mapping.js?v=20260809-tk-binder-pdf-fix-r2",
  ...
  "/scripts/teaching-kit-quality-review.js?v=20260809-tk-binder-pdf-fix-r2",
  ...
  "/app.js?v=20260809-tk-binder-pdf-fix-r2",
