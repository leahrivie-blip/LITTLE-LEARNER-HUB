const CACHE_NAME = "llh-shell-v144-boot-nav-pending";
const SHELL_VERSION = "20260801-boot-nav-pending";
...
const APP_SHELL = [
  ...
  "/app.js?v=20260801-boot-nav-pending",
