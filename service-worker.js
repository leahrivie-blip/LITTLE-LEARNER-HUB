const CACHE_NAME = "llh-shell-v136-admin-boot-landing";
const SHELL_VERSION = "20260730-admin-boot-landing";
...
const APP_SHELL = [
  ...
  "/index.html",
  "/offline.html",
  "/styles.css?v=20260730-admin-boot-landing",
  "/styles/llh-admin-workspace.css?v=20260730-admin-boot-landing",
  "/styles/llh-design-tokens.css?v=20260713-ds",
  "/styles/llh-homepage.css?v=20260730-admin-boot-landing",
  "/styles/llh-library-browse.css?v=20260717-netflix-cover-cards",
  "/styles/llh-messaging.css?v=20260730-admin-boot-landing",
  "/styles/llh-comms.css?v=20260730-admin-boot-landing",
  "/scripts/curriculum-safe-values.js?v=20260712-v3-render-fix",
  "/scripts/lesson-plan-cover-catalog.js?v=20260730-admin-boot-landing",
  "/scripts/lesson-plan-covers.js?v=20260730-admin-boot-landing",
  ...
  "/scripts/curriculum-lesson-viewer-render.js?v=20260730-admin-boot-landing",
  ...
  "/scripts/free-curriculum-sample.js?v=20260730-admin-boot-landing",
  "/scripts/trial-curriculum-exports.js?v=20260730-admin-boot-landing",
  "/scripts/free-plan-grandfathering.js?v=20260730-admin-boot-landing",
  "/app.js?v=20260730-admin-boot-landing",
  "/admin-workspace.js?v=20260730-admin-boot-landing",
  "/comms-center.js?v=20260730-admin-boot-landing",
  "/site.webmanifest",
