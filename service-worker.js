const CACHE_NAME = "llh-shell-v128-trial-card";
const SHELL_VERSION = "20260730-trial-card";
...
const APP_SHELL = [
  ...
  "/scripts/free-curriculum-sample.js?v=20260730-trial-card",
  "/scripts/trial-curriculum-exports.js?v=20260730-trial-card",
  "/scripts/free-plan-grandfathering.js?v=20260730-trial-card",
  "/app.js?v=20260730-trial-card",
  "/admin-workspace.js?v=20260730-trial-card",
