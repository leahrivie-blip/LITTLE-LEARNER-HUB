const CACHE_NAME = "llh-shell-v205-printable-idea-remove-r1";
const SHELL_VERSION = "20260817-printable-idea-remove-r1";
...
const APP_SHELL = [
  ...
  "/scripts/teaching-kit-enrichment-editor.js?v=20260817-printable-idea-remove-r1",
  ...
  "/app.js?v=20260817-printable-idea-remove-r1",
