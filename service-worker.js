const CACHE_NAME = "llh-shell-v198-tk-binder-pdf-fix-r4";
const SHELL_VERSION = "20260809-tk-binder-pdf-fix-r4";
...
const APP_SHELL = [
  ...
  "/scripts/teaching-kit-mapper.js?v=20260809-tk-binder-pdf-fix-r4",
  "/scripts/teaching-kit-printable-model.js?v=20260809-tk-binder-pdf-fix-r4",
  ...
  "/scripts/teaching-kit-binder-pdf.js?v=20260809-tk-binder-pdf-fix-r4",
  "/scripts/teaching-kit.js?v=20260803-tk-quality-review",
  "/scripts/teaching-kit-present.js?v=20260808-tk-pdf-merge",
  "/scripts/teaching-kit-print.js?v=20260809-tk-binder-pdf-fix-r4",
  "/scripts/teaching-kit-viewer.js?v=20260809-tk-binder-pdf-fix-r4",
  "/scripts/curriculum-day-field-mapping.js?v=20260809-tk-binder-pdf-fix-r4",
  ...
  "/scripts/teaching-kit-quality-review.js?v=20260809-tk-binder-pdf-fix-r4",
  ...
  "/app.js?v=20260809-tk-binder-pdf-fix-r4",
