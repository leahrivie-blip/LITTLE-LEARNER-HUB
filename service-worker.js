const CACHE_NAME = "llh-shell-v56-temp-password";
const OFFLINE_URL = "/offline.html";
const APP_SHELL = [
  "/",
  "/index.html",
  "/offline.html",
  "/styles.css?v=20260716-temp-password",
  "/styles/llh-design-tokens.css?v=20260713-ds",
  "/styles/llh-homepage.css?v=20260716-temp-password",
  "/styles/llh-library-browse.css?v=20260715-persistent-lesson-covers",
  "/styles/llh-messaging.css?v=20260716-temp-password",
  ...
  "/app.js?v=20260716-temp-password",
  "/comms-center.js?v=20260716-temp-password",
  "/site.webmanifest",
