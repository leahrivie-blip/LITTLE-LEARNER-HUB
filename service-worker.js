const CACHE_NAME = "llh-shell-v204-admin-deeplink-doublepaste-r1";
const SHELL_VERSION = "20260814-admin-deeplink-doublepaste-r1";
...
const APP_SHELL = [
  ...
  "/scripts/teaching-kit-enrichment-editor.js?v=20260812-tk-manual-kit-media-r1",
  ...
  "/app.js?v=20260814-admin-deeplink-doublepaste-r1",
