const CACHE_NAME = "llh-shell-v190-tk-print-system";
const SHELL_VERSION = "20260807-tk-print-system";
...
const APP_SHELL = [
  ...
  "/index.html",
  "/offline.html",
  "/styles.css?v=20260807-tk-print-system",
  ...
  "/scripts/llh-lesson-docx.js?v=20260807-tk-print-system",
  "/scripts/lesson-plan-weekly-export.js?v=20260717-more-menu",
  "/scripts/llh-teacher-weekly-planner.js?v=20260807-tk-print-system",
  ...
  "/scripts/teaching-kit-printable-model.js?v=20260807-tk-print-system",
  "/scripts/teaching-kit.js?v=20260803-tk-quality-review",
  "/scripts/teaching-kit-present.js?v=20260807-tk-print-system",
  "/scripts/teaching-kit-print.js?v=20260807-tk-print-system",
  "/scripts/teaching-kit-viewer.js?v=20260807-tk-print-system",
  ...
  "/app.js?v=20260807-tk-print-system",
