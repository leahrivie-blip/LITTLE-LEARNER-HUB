const CACHE_NAME = "llh-shell-v126-signup-verify";
const SHELL_VERSION = "20260730-signup-verify";
...
const APP_SHELL = [
  ...
  "/app.js?v=20260730-signup-verify",
