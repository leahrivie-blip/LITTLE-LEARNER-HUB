const CACHE_NAME = "llh-shell-v143-feedback-system";
const SHELL_VERSION = "20260801-feedback-system";
...
const APP_SHELL = [
  ...
  "/app.js?v=20260801-feedback-system",
