const CACHE_NAME = "llh-shell-v138-auth-button-audit";
const SHELL_VERSION = "20260730-auth-button-audit";
...
const APP_SHELL = [
  ...
  "/index.html",
  "/offline.html",
  "/styles.css?v=20260730-auth-button-audit",
  "/styles/llh-admin-workspace.css?v=20260730-auth-button-audit",
  "/styles/llh-design-tokens.css?v=20260713-ds",
  "/styles/llh-homepage.css?v=20260730-auth-button-audit",
  "/styles/llh-library-browse.css?v=20260717-netflix-cover-cards",
  "/styles/llh-messaging.css?v=20260730-auth-button-audit",
  "/styles/llh-comms.css?v=20260730-auth-button-audit",
  "/scripts/curriculum-safe-values.js?v=20260712-v3-render-fix",
  "/scripts/lesson-plan-cover-catalog.js?v=20260730-auth-button-audit",
  "/scripts/lesson-plan-covers.js?v=20260730-auth-button-audit",
  ...
  "/scripts/curriculum-lesson-viewer-render.js?v=20260730-auth-button-audit",
  ...
  "/scripts/free-curriculum-sample.js?v=20260730-auth-button-audit",
  "/scripts/trial-curriculum-exports.js?v=20260730-auth-button-audit",
  "/scripts/free-plan-grandfathering.js?v=20260730-auth-button-audit",
  "/app.js?v=20260730-auth-button-audit",
  "/admin-workspace.js?v=20260730-auth-button-audit",
  "/comms-center.js?v=20260730-auth-button-audit",
  "/site.webmanifest",
