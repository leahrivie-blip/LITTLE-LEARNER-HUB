const CACHE_NAME = "llh-shell-v133-ai-guide-p1";
const SHELL_VERSION = "20260730-ai-guide-p1";
...
const APP_SHELL = [
  ...
  "/scripts/free-curriculum-sample.js?v=20260730-ai-guide-p1",
  "/scripts/trial-curriculum-exports.js?v=20260730-ai-guide-p1",
  "/scripts/free-plan-grandfathering.js?v=20260730-ai-guide-p1",
  "/app.js?v=20260730-ai-guide-p1",
  "/admin-workspace.js?v=20260730-ai-guide-p1",
