const CACHE_NAME = "llh-shell-v206-linked-preview-keep-editor-r1";
const SHELL_VERSION = "20260817-linked-preview-keep-editor-r1";
...
const APP_SHELL = [
  ...
  "/app.js?v=20260817-linked-preview-keep-editor-r1",
